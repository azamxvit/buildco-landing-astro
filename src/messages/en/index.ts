...
const en: Messages = {
  ...
  projects: {
    ...
    items: {
      ...
      p3: { title: "McDonald's, Almaty", category: "Construction", description: "McDonald’s restaurant construction in Almaty." },
      p4: { title: "McDonald's, Aktobe", category: "Construction", description: "General contractor for McDonald’s in Aktobe." },
      p5: { title: "Air Liquide, Pavlodar Refinery", category: "Installation", description: "Piping and steelworks for HPU at PNHZ." },
      p6: { title: "Air Liquide, Atyrau Refinery", category: "Installation", description: "Piping fabrication and erection at ANPZ." },
